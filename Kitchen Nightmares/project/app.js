...
const createMeal = (meal,type) => {
    ...
    if ( meal.strYoutube ) {
        ...
        //mealMetadata +=`<span>YouTube:</span> <a href='${meal.strYoutube.replace("/watch?v=","/embed/")}' target="_blank" title="Watch how to cook ${meal.strMeal}">${meal.strYoutube.replace("/watch?v=","/embed/")}</a><br/>`
         mealMetadata+=`<span>Youtube:</span> <iframe width="560" height="315" src='${meal.strYoutube.replace("/watch?v=","/embed/")}' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`
    }
